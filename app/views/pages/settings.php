...
<html lang="en">
  ...
  <body class="bg-gray-100 flex items-center justify-center min-h-screen" style="background-color: #f4f2ee;">

    <div class="bg-white shadow-lg rounded-lg p-8 max-w-sm w-full text-center">
      <h1 class="text-3xl font-bold mb-4">Settings</h1>
      <p class="text-gray-600 mb-6">This page is currently under construction.</p>
      <svg class="w-16 h-16 mx-auto mb-4 text-gray-400 animate-bounce" xmlns="http://www.w3.org/2000/svg" fill="none"
        viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
      </svg>
      <p class="text-gray-500 mb-4">Please check back later.</p>
